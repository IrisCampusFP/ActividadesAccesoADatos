...
function crearCamion() {
    fetch("/admin/camiones", {
        ...
        body: JSON.stringify({
            ...
            fechaAlta: document.getElementById("fechaAltaCrear").value,
            activo: document.getElementById("activoCrear") ? document.getElementById("activoCrear").checked : true
        })
    })
        .then(r => {
...
function cargarDialogEditar(id) {
    fetch("/admin/camiones/" + id)
        ...
        .then(c => {
            ...
            const activoCheck = document.getElementById("activoEditar");
            if (activoCheck) activoCheck.checked = c.activo;
...
function editarCamion() {
    ...
    fetch("/admin/camiones/" + id, {
        ...
        body: JSON.stringify({
            ...
            fechaAlta: document.getElementById("fechaAltaEditar").value,
