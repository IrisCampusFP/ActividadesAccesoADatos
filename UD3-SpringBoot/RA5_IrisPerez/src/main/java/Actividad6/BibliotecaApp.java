...
public class BibliotecaApp {
    ...
    private void eliminarLibro() throws Exception {
        ...
        String confirmar = leerTexto("Esta seguro? (s/n): ");
    ...
    private void mostrarEstadisticas() throws Exception {
        List<Libro> todos = libroDAO.buscarTodos();
        List<Libro> disponibles = libroDAO.buscarDisponibles();

        System.out.println("\n··· ESTADISTICAS ···");
        System.out.println("Total libros: " + todos.size());
        System.out.println("Disponibles: " + disponibles.size());
        System.out.println("Prestados: " + (todos.size() - disponibles.size()));
    }
